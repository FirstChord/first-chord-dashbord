    ...
    if (!existingRow) {
      ...
      if (nextRow.sourcePresent !== 'true') {
        ...
        eventRows.push(buildEventRow({
          ...
          issue,
          previousStatus: normaliseIssueStatus(existingRow.status),
          nextStatus: normaliseIssueStatus(existingRow.status),
