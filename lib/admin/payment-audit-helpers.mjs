...
export function buildPauseExpectationAutoSyncEvent({
  student,
  previousValue = '',
  nextValue = '',
  occurredAt,
  ...
  return buildPaymentFieldChangeEvent({
    ...
    eventType: 'payment_expectation_auto_synced',
    actorEmail: 'system',
    occurredAt,
    auditContext: {
      source: 'pause_history_auto_sync',
      actionLabel: 'Auto-sync payment expectation from Pause History',
      note: reason,
    },
  });
}
