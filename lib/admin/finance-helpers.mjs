...
import { buildTutorCost, parseExpenses, resolveWeeklyWeight } from './cost-helpers.mjs';
...
export function buildFinanceOverview(students = [], { tutorPay = new Map(), expenseRows = [], stripeAmounts = null } = {}) {
