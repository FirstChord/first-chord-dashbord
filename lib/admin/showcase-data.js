/** @fileoverview Static definitions of the showcase workflow instances, their task groups, and shared venue and ticketing links. */
const COMMON_LINKS = {
  venue: {
    label: 'Nemo Arts',
...
const TASK_GROUPS = [
  ...
  },
  {
    ...
    guidance: [
      ...
      'Leave some flexibility for late additions.',
    ],
  },
  {
    id: 'logistics',
