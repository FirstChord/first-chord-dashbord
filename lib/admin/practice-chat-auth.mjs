/** @fileoverview Shared-secret authentication and CORS allowlist for the Practice Chat PWA endpoints. */
...
export function corsHeaders(origin = '') {
  ...
  return {
    ...
    // GET is for the read-only music-context lookup; every write is POST.
    'Access-Control-Allow-Methods': 'GET, POST, OPTIONS',
    'Access-Control-Allow-Headers': 'Authorization, Content-Type, X-FirstChord-PracticeChat-Secret',
    Vary: 'Origin',
  };
}
