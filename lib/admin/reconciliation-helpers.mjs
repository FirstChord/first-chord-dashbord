/** @fileoverview Deterministic, read-only reconciliation core resolving one episode's lessons against overlapping facts, with each consequence following its own rule. */
