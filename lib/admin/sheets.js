...
const PAYROLL_RUNS_SHEET = 'Payroll_Runs';
const TUTOR_WISE_SHEET = 'Tutor_Wise';
const TUTOR_PAY_HEADERS = ['tutor', 'pay_model', 'hourly_rate', 'monthly_salary', 'invoice_cadence', 'active_for_payroll', 'notes'];
...
const TUTOR_WISE_HEADERS = ['tutor', 'recipient_id', 'name', 'recipient_email', 'recipient_detail', 'source_currency', 'target_currency', 'amount_currency', 'receiver_type', 'notes'];
...
async function getSpreadsheetMetadata({ sheets, spreadsheetId, forceRefresh = false }) {
