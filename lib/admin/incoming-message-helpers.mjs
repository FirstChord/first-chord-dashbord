...
// non-lesson group, so park it as `unmatched` (hidden by default). Never
// downgrade a human decision or an existing review row.
export function decideSyncedGroupStatus(existingStatus = '', hasMatch = false) {
  ...
  if (existingStatus === 'review') return 'review';
