...
export function matchIncomingMessageToStudent(message = {}, students = []) {
...
export function buildIncomingMessageRecord(payload = {}, { students = [], now = new Date() } = {}) {
  ...
  const match = matchIncomingMessageToStudent(message, students);
