...
//
// Soundslice is the only entry: without it the record looks complete but the
// student has no practice link, and the gap is normally found weeks later by
// someone hunting for the missing course.
