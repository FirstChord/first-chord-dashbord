...
export function isOnboardingOperationallyComplete(completionStatus = {}) {
  return completionStatus.canonicalRecord?.status === 'complete'
    && completionStatus.mmsOperationalState?.status === 'complete';
}
