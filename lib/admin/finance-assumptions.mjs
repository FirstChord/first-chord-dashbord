/** @fileoverview Single version marker for the pricing and cost assumptions written into every Finance_Snapshot row so the series stays interpretable. */
...
export const PRICE_ASSUMPTIONS_VERSION =
  '2026-07.2 | 1:1 £25/£33/£41.50 wk (30/45/60m) | group £20 wk | orchestra £42.50 mo | default £24/hr +£2 group slot | VAT flat 11%';
