/** @fileoverview Allowlisted, in-code operations guidance snippets and their search; callers can never supply a path or read repository files. */
...
export const OPERATIONS_GUIDANCE_SECTIONS = Object.freeze([
  {
    ...
    sourcePath: 'docs/operations/runbook.md',
  ...
  },
  {
    ...
    sourcePath: 'docs/policies/payments.md',
  ...
  },
  {
    ...
    sourcePath: 'docs/architecture/data/ownership.md',
  ...
  },
  {
    ...
    sourcePath: 'docs/operations/integrations/whatsapp-incoming-bridge.md',
  ...
  },
  {
    ...
    sourcePath: 'docs/policies/hygiene-and-secrets.md',
  ...
  },
  {
    ...
    sourcePath: 'docs/architecture/data/state-tabs.md',
  ...
  },
  {
    ...
    sourcePath: 'docs/workflows/finance/paying-tutors.md',
