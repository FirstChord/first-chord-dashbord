...
function buildLoopState({ pauseSummary, paymentExpectation, stripeSnapshot }) {
  ...
  if (pauseSummary.currentlyPaused && paymentExpectation !== 'stripe_paused_expected') {
    return {
      ...
      nextAction: 'If the pause is correct, set payment expectation to Stripe paused expected. If the pause is wrong, correct Pause History before marking this closed.',
