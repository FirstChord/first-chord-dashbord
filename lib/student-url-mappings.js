...
export const STUDENT_URL_MAPPINGS = {
  // Arion's students
  'olivia-m': 'sdt_fyYPJK',          // Olivia Mcintosh
  ...
  'sadie-lindop': 'sdt_L8Y3JY',      // Sadie Lindop
  'enol': 'sdt_mGY6JY',              // Enol Pardo-Alguero
  'julied': 'sdt_mvK6JZ',            // Julie Donaldson
  'adam-brooks': 'sdt_m90dJj',       // Adam Brooks
  'kian': 'sdt_f2zpJ3',              // Kian Ojaghi
  'arvin': 'sdt_fytnJT',             // Arvin Ojaghi

  // Calum's students
  'sam': 'sdt_m7yfJG',               // Sam Reid
  'toros': 'sdt_fgBHJl',             // Toros Erskine
  'aaratrika': 'sdt_fcs0JQ',         // Aaratrika Ghatkar

  // Chloe's students
  'niamh-mccrudden': 'sdt_6Zd7J3',   // Niamh McCrudden
  'giorgio': 'sdt_6nhSJM',           // Giorgio O
  'charlie-gillespie': 'sdt_H5yHJQ', // Charlie Gillespie
  'melania': 'sdt_HVbNJk',           // Melania R
  'fallou': 'sdt_MdD4JB',            // Fallou Ndiaye
  'tabitha-slocombe': 'sdt_fFZdJb',  // Tabitha Slocombe
  'emma': 'sdt_c8fFJ3',              // Emma Snaraite
  'zoe': 'sdt_y0SPJJ',               // Zoe Bannatyne
  'thomas-mcgrath': 'sdt_cRXfJT',    // Thomas McGrath
  'rian': 'sdt_LXBCJ0',              // Rian Wilson
  'mavi': 'sdt_mqLVJ3',              // Mavi Ayhan
  'sandy-singing': 'sdt_fw0cJ3',     // Sandy (Singing) Morgan
  'mia': 'sdt_fwnBJg',               // Mia Mackinnon (piano)
  'vivian': 'sdt_fK3nJ9',            // Vivian Schmiedecke
  'emeline': 'sdt_fHpTJ6',           // Emeline Quillien-Visser
  'ayla': 'sdt_frnpJH',              // Ayla Mehmood
  'andrzej': 'sdt_fkZbJV',           // Andrzej Ishizaki
  'louise': 'sdt_fb4YJV',            // Louise Boland

  // David's students
  'dimitra': 'sdt_L5l5JD',           // Dimitra Ntarmou
  ...
  'theodore': 'sdt_fl9nJD',          // Theodore Henderson

  // Dean's students
  'mohammed': 'sdt_2lJMJl',          // Mohammed Abdelrahman
  'rayan': 'sdt_2lJyJj',             // Rayan Abdelrahman
  'harrison': 'sdt_2sjZJs',          // Harrison Aitken
  'emilia': 'sdt_3TTwJV',            // Emilia Douglas
  'dylan-cook': 'sdt_3nKZJB',        // Dylan Cook
  'daniela': 'sdt_BDHTJN',           // Daniela Alvarez
  'yahya': 'sdt_Fq8ZJ1',             // Yahya Faraj
  'ariana': 'sdt_Hf36Jh',            // Ariana Honeybunn
  'gil': 'sdt_HrdXJK',               // Gil Wallace
  'zayn': 'sdt_NxMZJz',              // Zayn Speirs
  'ada': 'sdt_QnkRJT',               // Ada Neocleous
  'alice': 'sdt_BDHqJv',             // Alice Drew
  'james-t': 'sdt_cYDxJM',           // James Taylor
  'harry-wallace': 'sdt_cfbyJQ',     // Harry Wallace
  'charlotte': 'sdt_csfBJd',         // Charlotte Lawrie
  'stella-hart': 'sdt_sfbtJ5',       // Stella Hart
  'lola': 'sdt_svMqJy',              // Lola McGarry Panunzio
  'sandy': 'sdt_vHS3JK',             // Sandy Morgan
  'daniel': 'sdt_yHtZJ8',            // Daniel Murray
  'poyraz': 'sdt_mNY8JF',            // Poyraz Demirci
  'mia-dean': 'sdt_mwvmJz',          // Mia Mackinnon
  'matteo': 'sdt_cCw9Jz',            // Matteo Malara
  'paul-t': 'sdt_rJTyJ4',            // Paul Taylor
  ...
  'dylan-lyall': 'sdt_ySKCJy',       // Dylan Lyall
  ...
  'niamh-walker': 'sdt_L1NQJl',      // Niamh Walker
  'aisling': 'sdt_Ll4DJt',           // Aisling Mackenzie
  'patricia': 'sdt_mvhgJ3',          // Patricia Miranda
  'mariam': 'sdt_f2VgJD',            // mariam farhani
  'anna-m': 'sdt_ff2SJf',            // Anna McPhail
  ...
  'thomas-ward': 'sdt_BDHdJ4',       // Thomas Ward
  ...
  'nina-brown': 'sdt_cZsMJD',        // Nina Brown
  ...
  'emily': 'sdt_f50CJ3',             // Emily Grifa
  'nina-gavlin': 'sdt_f576Jx',       // Nina Gavlin
  'logan-p': 'sdt_fn5wJR',           // Logan Petrie

  // Kim's students
  'mark-chalmers': 'sdt_38MBJF',     // Mark Chalmers
  'reuben': 'sdt_BkflJy',            // Reuben Barnes
  'lyra': 'sdt_HbXMJZ',              // Lyra Jackson
  'caroline': 'sdt_QbBNJq',          // Caroline Bingley
  'marco': 'sdt_QcCtJT',             // Marco Sarconi
  'nicholas': 'sdt_mfFYJ0',          // Nicholas Wyllie
  ...
  'ailsa-macfarlane': 'sdt_mv22J8',  // Ailsa Macfarlane
  'lynsey': 'sdt_LfgQJd',            // Lynsey Lamond
  'lachlan': 'sdt_mSDKJ1',           // Lachlan Venturi
  'jasleen': 'sdt_fGR3Jk',           // Jasleen Rai

  // Robbie's students
  'charlie-mcdougall': 'sdt_2s8CJk', // Charlie Mcdougall
  'ailsa-hoebe': 'sdt_3ZZwJ2',       // Ailsa Hoebe
  'emiliano': 'sdt_c7hKJ8',          // Emiliano Squillino
  'niamh-gallagher': 'sdt_vgjdJv',   // Niamh Gallagher
  ...
  'nina-hamilton': 'sdt_LpXfJQ',     // Nina Hamilton
  'alba': 'sdt_LNvQJ7',              // Alba McMillan
  'katie': 'sdt_cZsDJp',             // Katie Brown
  'gaia': 'sdt_fsB1Jm',              // Gaia Knight
  'martha': 'sdt_mZbRJh',            // Martha Jefferson
  'emelyn': 'sdt_fcSVJh',            // Emelyn Fuller
  'kristina': 'sdt_rJqnJf',          // Kristina Maclachlan
  'lena': 'sdt_rJq0Jm',              // Lena Maclachlan
  ...
  'roque': 'sdt_s2JpJx',             // Roque Neto
  'jack': 'sdt_wwqLJ2',              // Jack Alexander
  'lawrence': 'sdt_fkkLJ0',          // LAWRENCE GALLIO

  // Tom's students
  'charlie-norton': 'sdt_417JJ3',    // Charlie Norton
  'ruaraidh': 'sdt_6PjKJF',          // Ruaraidh Somerville
  'luke': 'sdt_BMtHJs',              // Luke Moran
  'carol': 'sdt_BtxmJ4',             // Carol Turner
  'sadie-lowe': 'sdt_D9ftJB',        // Sadie Lowe
  'rosie-ward': 'sdt_DdxtJZ',        // Rosie Ward
  'logan': 'sdt_F3FHJs',             // Logan Wilson
  'cormac': 'sdt_FXKDJS',            // Cormac Morton
  'stella-french': 'sdt_Nt4LJ3',     // Stella French
  'carla': 'sdt_QjMGJc',             // Carla Jurado
  'annie': 'sdt_cZ39Jz',             // Annie Brown
  'luca': 'sdt_gDcVJp',              // Luca Kennedy
  'duke': 'sdt_gpFVJS',              // Duke Noramly
  'rosie-kinniburgh': 'sdt_pFYFJT',  // Rosie Kinniburgh
  'sonny-ford': 'sdt_pT5MJz',        // Sonny Ford
  'harry-dafas': 'sdt_slc4Jq',       // Harry Dafas
