...
> and [`../admin/CURRENT_STATUS.md`](../../CURRENT_STATUS.md). Do not use the
...
docs/history/legacy-portal/adding-new-students-registry.md    # Step-by-step student portal setup
...
### **Adding New Students** 
1. Follow `docs/history/legacy-portal/adding-new-students-registry.md` exactly
