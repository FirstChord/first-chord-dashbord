...
> the onboarding row in [`../admin/OWNERSHIP_MATRIX.md`](../../architecture/data/ownership.md),
...
- [ADDING_NEW_STUDENTS.md](./adding-new-students-registry.md) - Detailed guide
- [STUDENT_REGISTRY_GUIDE.md](../../reference/student-registry.md) - Registry system docs
- [VALIDATION_GUIDE.md](../../reference/student-registry-validation.md) - Validation details
