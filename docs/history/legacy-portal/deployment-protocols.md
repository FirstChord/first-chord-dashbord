...
> [`../admin/OPERATIONS_RUNBOOK.md`](../../operations/runbook.md).

**Last Updated**: September 29, 2025  
**Verified Working**: Kenny student setup and URL simplification  
**Related Files**: [Adding New Students](./adding-students-workflow.md), [NOTES_EDGE_CASE_PROTOCOL.md](./notes-edge-case.md)
...
> **For the legacy manual student portal setup, see [Adding New Students](./adding-students-workflow.md).**
