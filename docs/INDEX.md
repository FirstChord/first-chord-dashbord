...
- **[Current Admin Status](admin/CURRENT_STATUS.md)** - Current V3 admin direction, recent work, and next slices
...
- **[File Structure Guide](FILE_STRUCTURE_GUIDE.md)** - Project organization
- **[Student Registry Guide](STUDENT_REGISTRY_GUIDE.md)** - Registry system documentation
- **[Student Portal System](STUDENT_PORTAL_SYSTEM.md)** - Portal architecture
- **[Technical Maintenance](TECHNICAL_MAINTENANCE_GUIDE.md)** - Maintenance procedures
- **[Troubleshooting Guide](TROUBLESHOOTING_GUIDE.md)** - Detailed troubleshooting
- **[Validation Guide](VALIDATION_GUIDE.md)** - Data validation procedures
- **[WordPress Redirect Setup](WORDPRESS_REDIRECT_SETUP.md)** - WordPress integration
- **[Google Sheets Setup](guides/GOOGLE_SHEETS_SETUP_GUIDE.md)** - Sheets configuration
- **[Google Sheets Schema](guides/GOOGLE_SHEETS_SCHEMA.md)** - Data schema reference
...
- **[Notes Edge Case Protocol](protocols/NOTES_EDGE_CASE_PROTOCOL.md)** - Handling edge cases
