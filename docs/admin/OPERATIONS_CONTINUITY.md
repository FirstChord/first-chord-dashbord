...
*Created 2026-07-19. The machine-side twin is [`DISASTER_RECOVERY.md`](DISASTER_RECOVERY.md)
...
4. **Weekly:** the seeded planning prompts (Monday scheduling, Friday reflection) say
   what day it is. Follow **[`06-paying-tutors.md`](../workflows/06-paying-tutors.md)**
...
5. **When something breaks:** `DISASTER_RECOVERY.md` for data/machine incidents;
   `OPERATIONS_RUNBOOK.md` for per-credential "what breaks if" and recovery.
