...
- **Verify piano's ~26 `artist: 'RSL'` songs.** Piano was ingested before `'RSL'` gained its second meaning (true artist of a Rockschool Original vs needs-curation marker), so its markers are an unresolved mix. **The biggest piece of catalogue debt.** The official RSL Awards syllabus pages settle it — they group covers separately from originals.
