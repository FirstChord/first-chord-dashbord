...
| **Stripe / Gmail restricted keys** | Payment reads / practice-note email | Re-issue in provider dashboards; scopes documented in `AI_RUNTIME_INTEGRATION.md` (AI key), `CURRENT_STATUS.md` policy notes (Stripe read scopes) | n/a |
