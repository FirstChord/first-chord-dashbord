...
> Phase 2 (AI)
> deliberately not started — needs its own `AI_TOOL_CONTRACTS.md` allowlist entry and
...
Mirror the house pattern already used for issue briefings (`docs/admin/AI_TOOL_CONTRACTS.md`
...
3. **Governance.** Add this capability to `docs/admin/AI_TOOL_CONTRACTS.md` allowlist
