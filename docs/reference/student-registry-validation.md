...
- See: `docs/history/legacy-portal/adding-students-workflow.md` - Includes validation step
- See: `docs/history/legacy-portal/deployment-checklist.md` - Pre-deployment validation
- See: `docs/history/legacy-portal/troubleshooting-workflow.md` - Fix validation errors
