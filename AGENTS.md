...
| Practice Chat and notes | `app/api/practice-notes/`, `app/api/admin/practice-notes/` | `lib/admin/practice-*.mjs`, `lib/admin/practice-notes-email.js`, `lib/admin/sheets/practice-notes.mjs` | `docs/workflows/practice-chat/delivery.md`, `docs/plans/active/practice-chat-whisper-hardening.md` | `practice-*` |
