...
| Assistant-safe foundations | deterministic issue explanation UI + read-only route; no model/tool runtime | `app/api/admin/issues/[mmsId]/explanation/`, `components/admin/issues/IssueExplanationPanel.js`, `lib/admin/issue-explanation-helpers.mjs`, `lib/admin/assistant-context-*`, `lib/admin/operations-guidance-helpers.mjs`, `lib/admin/communication-draft-proposal-helpers.mjs`, `lib/admin/incoming-eval-helpers.mjs` | `AI_TOOL_CONTRACTS.md`, `STATE_TABS_SCHEMA.md`, `HYGIENE_AND_SECRETS.md` | `issue-explanation-*`, `assistant-context-*`, `operations-guidance-helpers`, `communication-draft-proposal-helpers`, `incoming-classifier-eval`, `evaluation-fixture-privacy` |
